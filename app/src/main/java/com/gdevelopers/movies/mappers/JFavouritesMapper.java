...
public class JFavouritesMapper extends JObjectMapper {
    private final Context context;

    public JFavouritesMapper(Context context, Server server) {
        super(server);
        this.context = context;
    }

    public List<KObject> getFavouriteMovies(String accountId, String sessionId, String page, boolean more, boolean reload, String sortBy) {
        ...
        if (_loadedObjects.isEmpty() || reload) {
            return this.load("account/" + accountId + "/favorite/movies", hashMap);
        }

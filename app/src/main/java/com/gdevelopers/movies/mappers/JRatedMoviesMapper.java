...
public class JRatedMoviesMapper extends JObjectMapper {
    private final Context context;

    public JRatedMoviesMapper(Context context, Server server) {
        super(server);
        this.context = context;
    }

    public List<KObject> getRatedMovies(String accountId, String sessionId, String page, boolean more, boolean reload, String sortBy) {
        ...
        if (_loadedObjects.isEmpty() || reload) {
            return this.load("account/" + accountId + "/rated/movies", hashMap);
        }
